...
import { MapPin, TrendingUp, Volume2, Wind, AlertTriangle, Table as TableIcon } from "lucide-react"
...
export default function HeuballernPage() {
  ...
  const { data: chartData } = useStationData("heuballern", chartInterval, granularity)
            ...
            <Card className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm border-gray-200 dark:border-gray-700 shadow-xl min-h-[7rem]">
              ...
              <CardContent>
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-lg lg:text-2xl font-bold text-cyan-400">{currentWind != null ? currentWind : "keine daten"}</span>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={visibleData} ref={chartRef}>
                    ...
                    <Line
                      ...
                      strokeWidth={3}
                      dot={false}
                      activeDot={{ r: 6, fill: STATION_COLORS.heuballern.primary }}
                    />
                    <Line
                      type="monotone"
                      dataKey="ws"
