...
export default function HeuballernPage() {
  console.log('[Heuballern] Komponente wird gerendert');
  ...
  const { data, totalCount } = useStationData("heuballern", chartInterval, granularity)
  ...
  console.log('[Heuballern] visibleData.length:', visibleData.length, 'Beispiel:', visibleData[0]);
              ...
              <CardContent>
                <div className="flex items-center space-x-2">
                  ...
                  <UITooltip>
                    ...
                    <TooltipContent>24h Durchschnittswert in dB</TooltipContent>
                  </UITooltip>
                  <span className="text-xs lg:text-sm text-gray-500">dB</span>
                </div>
            ...
            <Card className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm border-gray-200 dark:border-gray-700 shadow-xl min-h-[7rem]">
              ...
              <CardContent>
                <div className="flex items-center space-x-2">
                  ...
                  <UITooltip>
                    <TooltipTrigger asChild>
                      <span className="text-lg lg:text-2xl font-bold text-purple-400">{currentWind != null ? currentWind : "keine daten"}</span>
                    </TooltipTrigger>
