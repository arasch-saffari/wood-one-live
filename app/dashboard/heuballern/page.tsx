...
import { MapPin, TrendingUp, Wind, Download, BarChart3, AlertTriangle } from "lucide-react"
...
export default function HeuballernPage() {
  ...
  const data = useStationData("heuballern", chartInterval)
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            <Link href="/dashboard/heuballern/table">Tabelle</Link>
          </Button>
          <Button
            variant="outline"
            size="sm"
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
          <Card className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm border-gray-200 dark:border-gray-700 shadow-xl">
            ...
            <CardContent>
              <div className="flex items-center space-x-2">
                <MapPin className="w-3 lg:w-4 h-3 lg:h-4 text-cyan-400" />
        ...
        <Card className="bg-white/80 dark:bg-gray-900/60 backdrop-blur-sm border-gray-200 dark:border-gray-700 shadow-xl">
          <CardHeader>
            <CardTitle className="flex items-center space-x-2 text-sm lg:text-base">
              ...
              <span className="text-gray-900 dark:text-white">Heuballern - Lärm & Wind</span>
            </CardTitle>
