...
import { Music, TrendingUp, Volume2, Clock, BarChart3, Download, Wind, AlertTriangle, Table as TableIcon } from "lucide-react"
...
export default function BandPage() {
  ...
  const { data, totalCount } = useStationData("band", chartInterval, granularity)
              ...
              <CardContent>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs text-purple-400">
                    <UITooltip>
                      <TooltipTrigger asChild>
                        <span className="cursor-help">{Number(trend) > 0 ? "+" : ""}{trend}% vs gestern</span>
                      </TooltipTrigger>
                      <TooltipContent>Prozentuale Änderung gegenüber gestern</TooltipContent>
                    </UITooltip>
                  </span>
                </div>
              </CardContent>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-lg lg:text-2xl font-bold text-red-400">
                    <UITooltip>
                      ...
                      <TooltipContent>Maximaler Lärmpegel in dB</TooltipContent>
                    </UITooltip>
                  </span>
                  <span className="text-xs lg:text-sm text-gray-500">dB</span>
                </div>
